...
public class Lending {
     ...
     *
     * @param       isbn {@code Book} object, which should be retrieved from the database.
     ...
     * */
    public Lending(String isbn, ReaderDetails readerDetails, int seq, int lendingDuration, int fineValuePerDayInCents){
        try {
